...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  const API_KEY = 'AIzaSyAHxO8ZCKPLODbhgSQcDV49Bv8cgkOA8Z4';  // YouTube Data API key
  // API URL pointing to deployed sentiment analysis service
  const API_URL = 'http://40.172.234.207:6091';
